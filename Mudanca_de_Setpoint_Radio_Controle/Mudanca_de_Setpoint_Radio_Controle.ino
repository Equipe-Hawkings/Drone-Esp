...
//  um MPU-6050. Neste código ainda foi adicionado a função de variar o      //
//  setpoint com um rádio controle, para isso utilizamos o rádio receptor    //
//  FS-82 e o rádio controle FS-i6. O protocolo de comunicação utilizado     //
//  foi o IBus.                                                              //
//                                                                           //
//  Ps_1: Como estamos utilizando o Arduino Nano e este conta com apenas     //
//  uma porta UART ao passar o código para o Arduino devemos desconectar     //
//  o pino IBus do receptor do Arduino e ao final da transferência do        //
//  código devemos conecta-lo novamente.                                     //
///////////////////////////////////////////////////////////////////////////////
//  Conexões:                                                                //
//                                                                           //
//  MPU-6050 - Arduino                                                       //
...
void loop(){
  //valor=map(valor, deMenor, deMaior, paraMenor, paraMaior);
  setpoint=map(sinal.readChannel(2), 1000, 2000, -40, 40);             // setpoint -> sinal do transmissor mapeado para a angulação da bancada
